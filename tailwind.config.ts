	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				...
				'listening': 'var(--shadow-listening)',
				'card': 'var(--shadow-card)'
			},
			fontFamily: {
				'alexa': ['Inter', 'system-ui', 'sans-serif']
			},
			...
			keyframes: {
				...
				'listening-pulse': {
					'0%, 100%': {
						transform: 'scale(1)',
						boxShadow: '0 0 40px hsl(var(--voice-listening) / 0.4)'
					},
					'50%': {
						transform: 'scale(1.05)',
						boxShadow: '0 0 80px hsl(var(--voice-listening) / 0.8)'
					}
				},
				'wave': {
					'0%, 100%': {
